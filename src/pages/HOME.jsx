...
>
  ...
  {/* Chat Messages */}
  <main className="w-full sm:w-[80%] flex flex-col h-screen">
    <div
    ...
    >
      {messages.length === 0 && (
        <div className="text-center mt-20">
          ...
          <p className={`text-lg sm:text-2xl ${theme === "dark" ? "text-gray-400" : "text-gray-300"}`}>
        ...
        >
          <div
            className={`w-full text-right rounded-lg p-3 text-sm sm:text-base ${
              message.role === "user" ? "bg-white text-black w-auto" : "bg-gray-200 text-black w-auto"
    ...
    <form
            ...
            className="p-1 rounded-full border-t bg-gray-100 dark:bg-gray-800"
          >
            <div className="relative">
              <input
                type="text"
